...
def admin_order_shipped(modeladmin, request, queryset):
    for order in queryset:
        ...
        send_mail('Order sent', 'Your order has been sent!', 'noreply@dropshipper_django_vue.com', ['mail@dropshipper_django_vue.com', order.email], fail_silently=False, html_message=html)
    return 
